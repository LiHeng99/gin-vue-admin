<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束时间"></el-date-picker>
        ...
        <el-form-item label="数据库驱动">
         <el-input v-model="searchInfo.driverClassName" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="数据库名称" prop="dbUserName" width="120" />
        <el-table-column align="left" label="密码" prop="dbPassword" width="120" />
        <el-table-column align="left" label="url" prop="dbUrl" width="120" />
        <el-table-column align="left" label="数据库驱动" prop="driverClassName" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateDbInfoFunc(scope.row)">变更</el-button>
...
const getTableData = async() => {
  const table = await getDbInfoList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
getTableData()
console.log("tableData.value", "ssssssssssssssssssssssssssssssss")
