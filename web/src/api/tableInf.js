...
export const deleteTableInfoByIds = (data) => {
  return service({
    url: '/able_info/deleteTableInfoByIds',
    method: 'delete',
    data
  })
}
...
export const getTableInfoList = (params) => {
  return service({
    url: '/able_info/getTableInfoList',
    method: 'get',
    params
  })
}
